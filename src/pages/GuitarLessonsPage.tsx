...
const lessons: LessonCard[] = [
  ...
  { title: 'E-Shape Barre Chord', description: 'Learn the moveable E-shape barre chord — the open E major chord shape shifted up the neck to play any major chord.', path: '/lessons/e-shape-barre-chord', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: 'A-Shape Barre Chord', description: 'Learn the moveable A-shape barre chord — the open A major chord shape shifted up the neck, with the root on the A string.', path: '/lessons/a-shape-barre-chord', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: 'Minor Barre Chords', description: 'Learn the Em-shape and Am-shape minor barre chords — the minor counterparts to the two essential barre shapes.', path: '/lessons/minor-barre-chords', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: 'Barre Chord Progressions', description: 'Play I–IV–V and I–V–vi–IV progressions using barre chords in every key — with E-shape and A-shape options for each chord.', path: '/lessons/barre-chord-progressions', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: 'CAGED Chord Shapes', description: 'Learn how the five open chord shapes — C, A, G, E, D — repeat across the entire neck, giving every major chord five distinct positions.', path: '/lessons/caged-chord-shapes', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: 'CAGED Scale Positions', description: 'Map the major scale to each of the five CAGED positions — the chord tones sit embedded inside each scale box, connecting chords and scales across the neck.', path: '/lessons/caged-scale-positions', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: 'Pentatonic Scales', description: 'Learn the major and minor pentatonic scales in all five positions — the most essential scales for soloing and improvisation in rock, blues, and pop.', path: '/lessons/pentatonic-scales', difficulty: 'intermediate', dateCreated: '2026-06-16' },
  { title: '7th Chord Arpeggios', description: 'Learn major 7th, dominant 7th, minor 7th, and minor 7♭5 arpeggios across the fretboard using the CAGED system.', path: '/lessons/seventh-chord-arpeggios', difficulty: 'intermediate', dateCreated: '2026-06-17' },
  ...
  { title: 'Two Note Per String Arpeggios', description: 'Master G major 7 arpeggios using two-note-per-string patterns.', path: '/lessons/two-note-arpeggios', difficulty: 'advanced', dateCreated: '2025-12-17' },
